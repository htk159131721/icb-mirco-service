...
class SidebarLogo extends Component {
  ...
  render() {
    ...
    return (
      <div className="gx-layout-sider-header" style={{background: "#fff"}}>

        {(navStyle === NAV_STYLE_FIXED || navStyle === NAV_STYLE_MINI_SIDEBAR) ? <div className="gx-linebar">

          <i
            className={`gx-icon-btn icon icon-${navStyle === NAV_STYLE_MINI_SIDEBAR ? 'menu-unfold' : 'menu-fold'} ${themeType !== THEME_TYPE_LITE ? 'gx-text-blue' : ''}`}
            onClick={() => {
        ...
        <Link to="/" className="gx-site-logo">
          {navStyle === NAV_STYLE_NO_HEADER_MINI_SIDEBAR && width >= TAB_SIZE ?
            ...
            themeType === THEME_TYPE_LITE ?
              <img alt="" width="65%" src={require("assets/images/logo-icarebase.png")}/> :
              <img alt="" width="65%" src={require("assets/images/logo-icarebase.png")}/>}
